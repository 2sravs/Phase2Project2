...
namespace WebAPIProject1.Controllers
{
    ...
    {
        private readonly WebProject1DbContext _context;

        public EmpProfilesController(WebProject1DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<EmpProfile>> PostEmpProfile(EmpProfile empProfile)
        {
          if (_context.EmpProfile == null)
          {
              return Problem("Entity set 'WebProject1DbContext.EmpProfile'  is null.");
          }
